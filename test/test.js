...
describe( 'distributions-triangular-quantile', function tests() {
	...
	it( 'should evaluate the quantle function of the Triangular distribution when provided a typed array', function test() {
